...
for feature_model in range(1, 6):
    ...
    evaluate_model(SVC(C=0.655,gamma=0.013,probability=True), eval(f'x_train{feature_model}'), y, mode, k, feature_model, eval(f'x_test{feature_model}'), y_test,model_name='svm')
